...
while True:
    ...
    #when pressed enter, it'll show the blurred mask of roi, with roi and the panl where it displays no.
    if cv.waitKey(10) == 13 or flag == 1:
        ...
        cv.destroyWindow('Trackbars') #closing the trackbars window as it's no longer in use
